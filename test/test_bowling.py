...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_calculate_score_when_strike_is_the_last_frame(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_score_when_strike_is_the_last_2_frames(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_best_score(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
